    ...
    return (
      <ScrollView style={styles.container}>
        <Text style={styles.text}>
          ...
          用户在本APP的任何行为必须遵循： (1) 传输资料时必须符合中国有关法规。
          (2) 使用信息服务不作非法用途和不道德行为。 (3) 不干扰或混乱网络服务。
          (4)
          遵守所有使用服务的网络协议、规定、程序和惯例。用户的行为准则是以因特网法规，政策、程序和惯例为根据的。
        </Text>
        <Text style={styles.text}>
          2、服务条款的修改 本APP有权在必要时修改条款，将会在页面公布。
        ...
        <Text style={styles.text}>
          4、拒绝提供担保 用户明确同意使用本公司服务，由用户个人承担风险。
        ...
        <Text style={styles.text}>
          6、对用户信息的存储和限制 本APP暂时不提供发布上处数据服务。
